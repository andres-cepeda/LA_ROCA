                        ...
                        <div class="container">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <h1 style="text-align: center; color: #000;"><strong><h3>Registar EPS</h3></strong></h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <form id="NuevaEPS" method="POST" action="{{ url('eps') }}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ old('NEPS') }}" type="text" class="form-control" id="NEPS" name="NEPS" placeholder="Nombre EPS">
                                                    <strong class="text-danger"> {{ $errors->first('NEPS') }} </strong>
                                                </div>
