  ...
  <header>
    <div class="d-flex" id="content-wrapper">
         ...
         <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
          <div class="container">
            <div class="logo">
              <a href="#" class="d-block text-dark p-3" ><strong><h1>La Roc@</h1></strong></a>
            </div>
        ...
        <div id="content">
          <section class="py-3">
            <div class="container">
              <div class="row">
                  <div class="col-lg-12">
                    <h1 style="color: #000000; text-align: center;" class="font-weight-bold mb-0"><strong> Bienvenido a la tienda virtual de La Roc@</strong></h1>
                    <h4 style="color: #000000; text-align: center;" class="font-weight-bold mb-0"><strong> A continuacion encontrara los productos disponibles en nuestra tienda</strong></h4>
                  </div>
              </div>
            </div>
          </section>
            ...
            <div class="container">
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-12">
                      <h1 style="text-align: center;"><strong><h1>Categorias</h1></strong></h1>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-3">
                      <a href="esferos.html" >
                      <h3 style="text-align: center;"><strong>Esferos </strong></h3>
                      <img src="../img/esfero.jpg" class=" img-fluid prod mr-4" alt="Foto esfero">
                      </a>
                    </div>
                    <div class="col-lg-3">
                      <a href="cartulinas.html">
                      <h3 style="text-align: center;"><strong>Cartulinas </strong></h3>
                      <img src="../img/cartulinas.jpg" class=" img-fluid prod mr-4" alt="Foto esfero">
                      </a>
                    </div>
                    <div class="col-lg-3">
                      <a href="esferos.html">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-3">
                      ...
                      <h3 style="text-align: center;"><strong>Cuadernos </strong></h3>
                      <img src="../img/cuaderno.jpg" class=" img-fluid prod mr-4" alt="Foto cuaderno">
                      </a>
                    </div>
                    <div class="col-lg-3">
                      <a href="cuadernos.html">
