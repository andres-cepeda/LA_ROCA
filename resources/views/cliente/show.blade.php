                        ...
                        <div class="container">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <h1><strong>Nombre:</strong> {{ $cliente->nombres}} {{ $cliente->apellidos}} </h1>
                                            <ul>
                                                <li><strong>Codigo cliente: </strong>{{ $cliente->codCli}}</li>
                                                <li><strong>Tipo documento: </strong>{{ $cliente->tipoDoc}}</li>
                                                <li><strong>Cedula: </strong>{{ $cliente->cedula}}</li>
                                                <li><strong>Telefono: </strong>{{ $cliente->tel}}</li>
                                                <li><strong>Email: </strong>{{ $cliente->email}}</li>
                                                <li><strong>Direccion: </strong>{{ $cliente->direccion}}</li>
                                                <li><strong>Estado: </strong>{{ $cliente->estado}}</li>
                                                <li><strong>Id Usuario: </strong>{{ $cliente->idUsuario}}</li>
                                            </ul>
