                                                ...
                                                <div class="form-row">
                                                  ...
                                                  <label>Tipo de documento:</label>
                                                    <select id="TipDoc" name="TipDoc" class="form-control" required>
                                                        <option value="{{$cliente->tipoDoc}}">C.C</option>
                                                        <option value="{{$cliente->tipoDoc}}">C.E</option>
                                                        <option value="{{$cliente->tipoDoc}}">T.I</option>
                                                        <option value="{{$cliente->tipoDoc}}">Pasaporte</option>
                                                    </select>
