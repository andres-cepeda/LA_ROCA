    ...
    <header>
        <div class="d-flex" id="content-wrapper">
            ...
            <div class="w-100 ">
                ...
                <!-- Modal Registrar -->
                <div class="container">
                    <div class="modal fade bd-example-modal-lg" id="registarClienteModal" tabindex="-1" role="dialog" aria-labelledby="tituloVentana" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 style="text-align: center;" id="tituloClienteEPS">Registrar Cliente</h5>
                                    ...
                                    <div class="alert alert-info">
                                        <form method="POST" action="{{ url('cliente') }}">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <input type="text" class="form-control" id="CodCli" name="CodCli" placeholder="Codigo cliente">
                                            </div>
                                            ...
                                            <div class="form-group">
                                              ...
                                              <input type="varchar" class="form-control" id="Dirección" name="Dirección" placeholder="Dirección">
                                            </div>
                        ...
                        <div class="container">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <h1 style="text-align: center; color: #000;"><strong><h3>Cliente</h3></strong></h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
